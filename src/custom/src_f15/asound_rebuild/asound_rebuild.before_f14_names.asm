...
aF15IiAdlib3149 db 'F15 II AdLib 3-14-91',0
                ...
                dw 0
                dw 0Ah
                dw offset asound_entry_0797
                dw offset asound_entry_07CC
                dw offset asound_entry_07DA
                dw offset asound_entry_0810
                dw offset asound_entry_0878
                dw offset asound_entry_0885
                dw offset asound_entry_085D
                dw offset asound_entry_082A
                dw offset asound_entry_0850
                dw offset asound_entry_07F3
                db 1B6h dup(53h)
...
; ---------------------------------------------------------------------------
asound_entry_0797:                      ; exported entry table offset 0797h
                push    bp
                mov     bp, sp
                mov     bx, [bp+6]
                mov     cx, [bp+8]
...
; ---------------------------------------------------------------------------
asound_entry_07CC:                      ; exported entry table offset 07CCh
                push    ds
                mov     ax, seg seg11a3
                mov     ds, ax
                assume ds:seg11a3
                ...
                retf
; ---------------------------------------------------------------------------
asound_entry_07DA:                      ; exported entry table offset 07DAh
                push    bp
                mov     bp, sp
                mov     bx, [bp+6]
                cmp     bx, 22h ; '"'
...
loc_12FB1:                              ; CODE XREF: seg127c:07E3↑j
                ...
                retf
; ---------------------------------------------------------------------------
asound_entry_07F3:                      ; exported entry table offset 07F3h
                push    bp
                mov     bp, sp
                mov     bx, [bp+6]
                cmp     bx, 4
                ...
                retf
; ---------------------------------------------------------------------------
asound_entry_0810:                      ; exported entry table offset 0810h
                push    bp
                push    es
                push    si
                push    di
...
loc_12FE4:                              ; CODE XREF: seg127c:081F↑j
                ...
                retf
; ---------------------------------------------------------------------------
asound_entry_082A:                      ; exported entry table offset 082Ah
                push    ds
                mov     ax, seg seg11a3
                mov     ds, ax
                assume ds:seg11a3
...
loc_13005:                              ; CODE XREF: seg127c:0840↑j
                ...
                retf
; ---------------------------------------------------------------------------
asound_entry_0850:                      ; exported entry table offset 0850h
                push    ds
                mov     ax, seg seg11a3
                mov     ds, ax
                assume ds:seg11a3
                ...
                retf
; ---------------------------------------------------------------------------
asound_entry_085D:                      ; exported entry table offset 085Dh
                push    bp
                mov     bp, sp
                push    ds
                mov     ax, seg seg11a3
...
loc_13032:                              ; CODE XREF: seg127c:086D↑j
                ...
                retf
; ---------------------------------------------------------------------------
asound_entry_0878:                      ; exported entry table offset 0878h
                push    ds
                mov     ax, seg seg11a3
                mov     ds, ax
                assume ds:seg11a3
                ...
                retf
; ---------------------------------------------------------------------------
asound_entry_0885:                      ; exported entry table offset 0885h
                push    ds
                mov     ax, seg seg11a3
                mov     ds, ax
                assume ds:seg11a3
